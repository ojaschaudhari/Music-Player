...
class Main_class():
    ...
    def about(self):
        mb.showinfo('About',
                    'This project is developed by Ruchit Thanki & Ojas Chaudhari.')
    ...
    def set_playlist(self):
        ...
        dir_ = filedialog.askdirectory(initialdir='D:\\,H:\\,G:\\,I:\\,C:\\', title='Select Directory')
        os.chdir(dir_)
    ...
    def open_file(self):
        dir_ = filedialog.askopenfilename(initialdir='G:/,H:/,I:/,C:/,D:/', title='Select File')
    ...
    def __init__(self):
        ...
        Button(win, text='Add a Folder.', bd=2, font=('arialblack', 13), width=25, command=self.set_playlist).place(
            x=552, y=10)
        ...
        global status_bar
        status_bar = Label(win, text='Welcome to Musify', relief_='Groov', anchor=W)
