...
# from PyQt5.QtWidgets import QDialog, QApplication, QFileDialog, QWidget, QMainWindow
#
#
# class Testing(QWidget):
#     def __init__(self):
#         super(Testing, self).__init__()
#         self.fname = QFileDialog.getOpenFileName(self, "Open file", os.getcwd(),
#                                                  "Music (*.mp3, *.ogg, *.wav)")
#         print("DEMO Obj")
...
# # root = Tk()
# # root.filename = filedialog.askopenfilenames(initialdir=os.getcwd(), title='Select a Media File',
# #                                             filetypes=(("Media files", "*.ogg"), ("Media files", "*.mp3")))
# # print(root.filename)
# # root.mainloop()
# #
